...
const basePages = {
  home: {
    ...
    heroIndexLabel: 'Custom product collections',
    heroFooterLeft: 'Custom metal gifts for international buyers',
    heroFooterRight: 'Artwork / finish / attachment / packaging',
    hotEyebrow: 'Plan your project',
    hotTitle: 'Turn an idea into a clear product specification',
    hotDescription: publicSiteCopy.positioning,
    categoriesEyebrow: 'Product collections',
    ...
    featureEyebrow: 'Finishes',
    featureTitle: 'Surface, relief, and color make the object legible.',
    featureDescription: 'Compare metal tone, reflectivity, relief, and color before approving the final artwork.',
    equipmentEyebrow: 'Product range',
    equipmentTitle: `${primaryKeyword} and related custom formats`,
    partnersEyebrow: 'Project essentials',
    partnersTitle: 'Start with the right product format.',
    ...
    briefStep3Description: 'Select color, plating, backing, ribbon, ring, chain, or leather construction.',
    ...
    finishTabLabel: 'Finish options',
    finishPolished: 'Polished',
    finishPolishedDescription: 'A reflective surface that emphasizes crisp edges, raised areas, and strong contrast.',
    finishMatte: 'Matte',
    finishMatteDescription: 'A restrained, low-reflection surface suited to quiet graphics and contemporary programs.',
    finishAntique: 'Antique',
    finishAntiqueDescription: 'Darkened recesses make relief, borders, and sculpted details easier to read.',
    finishDark: 'Dark metal',
    finishDarkDescription: 'A deep metal tone for monochrome, tactical, fashion, or high-contrast artwork.',
    finishImageAlt: 'Challenge coin finish and relief reference',
    finishCaptionEyebrow: 'Object study',
    finishCaption: 'Relief, edge, color, and surface finish',
    finishCta: 'Discuss finish options',
    factoryEyebrow: 'Product details',
    factoryTitle: 'The details that turn an idea into a manufacturable piece.',
    ...
    ctaDescription: 'Share the product, artwork, quantity, packaging, destination, and target date. Any undecided details can remain open for discussion.',
    ...
    conversionSlide1Description: 'Bring a logo, sketch, or reference. We help define the form, finish, color, and presentation around the way the piece will be used.',
    ...
    conversionSlide2Description: 'Compare materials, relief, finish, color, and presentation before production begins.',
    ...
    conversionSlide2Point3: 'Project details organized for clear approval',
    ...
    conversionTitle: 'Custom metal gifts for brands, events, and recognition',
    conversionDescription: 'Turn your logo, sketch, or idea into custom pins, challenge coins, medals, and keychains with clearly defined specifications and presentation.',
    ...
    processTitle: 'From artwork to delivery',
    processDescription: 'A clear path for defining, approving, producing, and delivering your custom gift.',
    step1Label: 'Step 1',
    step1Title: 'Send your artwork or idea',
    step1Description: 'Share a sketch, logo, photo, or reference object.',
    step2Label: 'Step 2',
    step2Title: 'Review the artwork proof',
    step2Description: 'We define the form, finish, color, and hardware around your artwork.',
    step3Label: 'Step 3',
    step3Title: 'Approve the design and specification',
    step3Description: 'Confirm the artwork and project specification before production.',
    step4Label: 'Step 4',
    step4Title: 'Complete delivery',
    ...
    productionDescription: 'See tooling, metalworking, finishing, inspection, packing, and storage across the production process.',
  },
  products: {
    ...
    summaryProducts: 'products available',
    summaryCategories: 'product categories',
    summaryFactory: 'ready to explore',
    customEyebrow: 'Your project',
    customTitle: 'Turn your idea into a clear product specification.',
    customDescription: 'Choose the product format first, then compare materials, relief, finishes, fittings, ribbons, hardware, and packaging.',
    ...
    seriesEyebrow: 'All products',
    seriesTitle: 'Explore the Golden One collections',
  },
  product: {
    metaReady: 'Custom artwork',
    distributorSupport: 'Sales support',
    internationalSupport: 'International projects',
    stickyText: 'Clear product information for comparison and quotation.',
    requestQuote: 'Request quote',
    viewCategory: 'View category',
    highlightsEyebrow: 'At a glance',
    highlightsTitle: 'What defines this product.',
    applicationsEyebrow: 'Applications',
    applicationsTitle: 'Typical uses',
    specsEyebrow: 'Product options',
    specsTitle: 'General specifications and available options.',
    modelEyebrow: 'Model specifications',
    overviewEyebrow: 'About this product',
    faqEyebrow: 'FAQ',
    faqTitle: 'Common questions.',
    relatedEyebrow: 'Related items',
    relatedTitlePrefix: 'Compare more',
    relatedDescription: 'Compare more products in the same category and find the right format for your project.',
  },
  about: {
    title: `About ${siteInfo.name}`,
    description: publicSiteCopy.positioning,
    bannerEyebrow: 'About',
    bannerTitle: 'Custom metal gift experience since 2006.',
    bannerDescription: publicSiteCopy.positioning,
    systemEyebrow: 'How we work',
    systemTitle: 'Every project begins with its purpose, artwork, and product format.',
    systemDescription: 'Since 2006, Golden One has developed custom metal gifts from buyer artwork. Share the intended use and project context, and the team will help define the details needed for quotation and production.',
    whatWeBuild: 'What you can expect',
    whatWeBuildDescription: 'Clear product information, practical artwork support, and a direct way to discuss pins, coins, medals, keychains, and other custom metal gifts.',
  ...
  contact: {
    ...
    bannerTitle: 'Tell us what you want to create.',
    ...
    formTitle: 'Share your project details.',
...
const staticTextKeys: Record<string, string> = {
  'Compare the design, intended use, and available options before preparing your quotation request.': 'text.productOverview',
  'product series': 'text.productSeries',
  'Compare products by design, intended use, available options, and fit for your project.': 'text.productCategoryDescription',
  ...
  'Product information written for international buyers.': 'text.aboutReachDescription',
  Email: 'text.email',
  Phone: 'text.phone',
